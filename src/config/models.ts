...
export type ResolversTypes = {
	...
	id_String_NotNull_pattern_unifoxlayer7teamlognefusemotionteacher: ResolverTypeWrapper<
		Scalars["id_String_NotNull_pattern_unifoxlayer7teamlognefusemotionteacher"]
	>
	...
	phoneNumberList_List_ListNotNull_String_NotNull_pattern_010098: ResolverTypeWrapper<
		Scalars["phoneNumberList_List_ListNotNull_String_NotNull_pattern_010098"]
	>
...
> = {
	getFormByClub?: Resolver<
		ResolversTypes["FormConnection"],
		ParentType,
		ContextType,
		RequireFields<QueryGetFormByClubArgs, "club" | "offset">
	>
	getFormByStudentId?: Resolver<
		ResolversTypes["FormConnection"],
		ParentType,
		ContextType,
		RequireFields<QueryGetFormByStudentIdArgs, "offset" | "studentId">
	>
	getStudentByClub?: Resolver<
		Array<ResolversTypes["Student"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetStudentByClubArgs, "club">
	>
...
export type FormConnectionResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes["FormConnection"] = ResolversParentTypes["FormConnection"]
> = {
...
export type FormEdgeResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes["FormEdge"] = ResolversParentTypes["FormEdge"]
> = {
...
export interface Name_String_NotNull_MaxLength_5ScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes["name_String_NotNull_maxLength_5"], any> {
	name: "name_String_NotNull_maxLength_5"
}

export interface PhoneNumber_String_NotNull_Pattern_010098ScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes["phoneNumber_String_NotNull_pattern_010098"], any> {
...
> = {
	createForm?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCreateFormArgs, "input">
	>
	healthCheck?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationHealthCheckArgs, never>
	>
...
export interface Data_String_NotNull_Pattern_PingScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes["data_String_NotNull_pattern_ping"], any> {
	name: "data_String_NotNull_pattern_ping"
}

export interface Id_String_NotNull_Pattern_Unifoxlayer7teamlognefusemotionteacherScalarConfig
	extends GraphQLScalarTypeConfig<
		ResolversTypes["id_String_NotNull_pattern_unifoxlayer7teamlognefusemotionteacher"],
		any
	> {
	name: "id_String_NotNull_pattern_unifoxlayer7teamlognefusemotionteacher"
}

export interface Password_String_NotNull_MaxLength_30ScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes["password_String_NotNull_maxLength_30"], any> {
...
export interface Message_String_NotNull_MaxLength_80ScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes["message_String_NotNull_maxLength_80"], any> {
	name: "message_String_NotNull_maxLength_80"
}

export interface PhoneNumberList_List_ListNotNull_String_NotNull_Pattern_010098ScalarConfig
	extends GraphQLScalarTypeConfig<
		ResolversTypes["phoneNumberList_List_ListNotNull_String_NotNull_pattern_010098"],
		any
	> {
